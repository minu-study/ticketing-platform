...
public enum ErrorCode {
    ...
    RESERVATION001("RESERVATION001", "예약가능한 좌석이 아닙니다."),
    ...
    PAYMENT005("PAYMENT005", "대기 예약만 결제가 가능합니다,  예약 상태를 확인해주세요."),
    PAYMENT007("PAYMENT007", "결제 처리 중 오류가 발생했습니다."),
    PAYMENT008("PAYMENT008", "취소가 불가한 예약입니다."),
    ;
